...
def build_regular_tokens_list(tokenizer: PreTrainedTokenizerBase) -> List[Tuple[int, str, bool]]:
...
def build_transformers_prefix_allowed_tokens_fn(tokenizer: PreTrainedTokenizerBase, 
    ...
    def decode_fn(tokens: List[int]) -> str:
        ...
        return cleaned
    token_enforcer = TokenEnforcer(regular_tokens, character_level_parser, decode_fn, tokenizer.eos_token_id)
